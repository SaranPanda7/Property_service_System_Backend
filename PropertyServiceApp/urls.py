...
urlpatterns = [
    ...
    path('fetch_service_requests_for_agent/', fetch_service_requests_for_agent,
         name='fetch_service_requests_for_agent/'),
    path('fetch_all_users/', fetch_all_users,
         name='fetch_all_users/'),
    path('fetch_all_customers/', fetch_all_customers,
