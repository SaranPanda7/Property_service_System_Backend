# Generated by Django 3.2.12 on 2022-03-21 06:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.TextField(blank=True, max_length=255)),
                ('role', models.ForeignKey(blank=True, default=1, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='PropertyServiceApp.roles')),
            ],
        ),
    ]
